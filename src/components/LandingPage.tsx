        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
              Create memorable events or discover exciting experiences in your area. 
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-shadow">
                ...
                <p className="text-gray-600 mb-6">
                  Create and manage events, track RSVPs, and build your community.
                </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/50">
        <div className="max-w-md mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Sign in to start organizing or attending events</p>
          </div>
          <SignInForm />
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-8">Connecting communities through amazing events</p>
